...
st.write('都道府県別データの時系列データをラインプロットします。データの種類は、左タブから選択できます。また、データは曜日によって大きく変動します。この変動は一週間の移動平均をとることで抑えることができ、これも左タブの「移動平均」から選択できます。初期設定では、データの種類を「10万人あたりの新規感染者数」、移動平均を「あり」としています。')
